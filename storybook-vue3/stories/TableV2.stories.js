import WkTableV2 from '../../src/components/table-v2/Table.vue'
...
export const Primary = () => ({
  ...
  template: `
    <div style="padding: 24px; max-width: 960px;">
      <WkTableV2 :columns="columns" :data-source="data" />
    </div>
  `
})
Primary.parameters = {
...
export const Bordered = () => ({
  ...
  template: `
    <div style="padding: 24px; max-width: 960px;">
      <WkTableV2 :columns="columns" :data-source="data" :bordered="true" />
    </div>
  `
})
Bordered.parameters = {
...
export const LoadingState = () => ({
  ...
  template: `
    <div style="padding: 24px; max-width: 960px; display: flex; flex-direction: column; gap: 12px;">
      ...
      <WkTableV2 :columns="columns" :data-source="data" :loading="loading" />
    </div>
  `
})
  ...
  template: `
    <div style="padding: 24px; max-width: 960px; display: flex; flex-direction: column; gap: 32px;">
      <div>
        ...
        <WkTableV2 :columns="columns" :data-source="[]" />
      </div>
      <div>
        <p style="margin: 0 0 10px; font-size: 13px; font-weight: 500; color: #6b7280;">Custom emptyText</p>
        <WkTableV2 :columns="columns" :data-source="[]" empty-text="Không có dữ liệu phù hợp" />
      </div>
    </div>
  `
})
...
export const WithRowSelection = () => ({
  ...
  template: `
    <div style="padding: 24px; max-width: 960px; display: flex; flex-direction: column; gap: 12px;">
      ...
      <WkTableV2 :columns="columns" :data-source="data" :row-selection="rowSelection" />
    </div>
  `
})
...
export const WithRowDraggable = () => ({
  ...
  template: `
    <div style="padding: 24px; max-width: 700px; display: flex; flex-direction: column; gap: 12px;">
      ...
      <WkTableV2 :columns="columns" :data-source="data" :row-draggable="rowDraggable" :bordered="true" />
    </div>
  `
})
  ...
  template: `
    <div style="padding: 24px; max-width: 960px; display: flex; flex-direction: column; gap: 40px;">
      ...
      <div>
        ...
        <WkTableV2 :columns="columns" :data-source="data" :bordered="true" :row-selection="rowSelection" />
      </div>
      <div>
        ...
        <WkTableV2 :columns="columns" :data-source="data" :scroll="{ y: 200 }" :row-selection="rowSelection" />
      </div>
      <div>
        ...
        <WkTableV2 :columns="columns" :data-source="data" :loading="true" />
      </div>
      <div>
