  ...
  template: `
    <div style="display:flex; flex-direction:column; gap:12px; align-items:flex-start;">
      <WkToggleGroup v-model="active" :multiple="true">
        ...
        <WkToggle value="italic">
          <template #icon>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-italic-icon lucide-italic"><line x1="19" x2="10" y1="4" y2="4"/><line x1="14" x2="5" y1="20" y2="20"/><path d="M15 4 9 20"/></svg>
          </template>
        </WkToggle>
        <WkToggle value="underline">
          <template #icon>
        ...
        <WkToggle value="strike">
          <template #icon>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-strikethrough-icon lucide-strikethrough"><path d="M12 4v8a5 5 0 0 0 10 0V4"/><path d="M2 12h20"/></svg>
          </template>
        </WkToggle>
      </WkToggleGroup>
