...
describe('Input', () => {
  it('renders with default value and placeholder', () => {
    const w = mount(Input, { props: { value: 'hello', placeholder: 'Type...' } })
  ...
  it('prefers modelValue over value', () => {
    const w = mount(Input, { props: { value: 'a', modelValue: 'b' } })
  ...
  it('emits pressEnter on Enter key', async () => {
    const w = mount(Input, { props: { value: 'go' } })
  ...
  it('error and disabled props apply state classes', () => {
    const w = mount(Input, { props: { error: true, disabled: true } })
